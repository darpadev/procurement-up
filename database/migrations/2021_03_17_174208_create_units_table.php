...
class CreateUnitsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('units', function (Blueprint $table) {
            $table->id();
            $table->foreignId('parent')->constrained('origins');
            $table->string('name');
            $table->timestamps();
        });
        ...
        DB::table('origins')->insert([
            ...
            ['name' => 'Fakultas Komunikasi dan Diplomasi', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'Fakultas Teknologi Produksi dan Eksplorasi', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')],
            ['name' => 'Fakultas Ekonomi dan Bisnis', 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')]
        ]);
    }
